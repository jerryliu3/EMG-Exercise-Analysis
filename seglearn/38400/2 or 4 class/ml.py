...
# read the data
X = np.array([np.array(pd.read_csv('BC_38400.csv', sep=",", header=None)),
              np.array(pd.read_csv('BC_38400_Copy.csv', sep=",", header=None)),
              np.array(pd.read_csv('BP_38400.csv', sep=",", header=None)),
              np.array(pd.read_csv('BP_38400_Copy.csv', sep=",", header=None))])

# create the label vector and the corresponding semantic vector
y = np.array([0,1,2,3])
labels = ['BC','BC_Copy','BP','BP_Copy']
