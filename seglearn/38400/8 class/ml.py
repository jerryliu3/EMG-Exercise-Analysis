...
# read the data
X = np.array([np.array(pd.read_csv('LB_BC_38400.csv', sep=",", header=None)),
              np.array(pd.read_csv('RB_BC_38400.csv', sep=",", header=None)),
              np.array(pd.read_csv('LF_BC_38400.csv', sep=",", header=None)),
              np.array(pd.read_csv('RF_BC_38400.csv', sep=",", header=None)),
              np.array(pd.read_csv('LB_BP_38400.csv', sep=",", header=None)),
              np.array(pd.read_csv('RB_BP_38400.csv', sep=",", header=None)),
              np.array(pd.read_csv('LF_BP_38400.csv', sep=",", header=None)),
              np.array(pd.read_csv('RF_BP_38400.csv', sep=",", header=None))])

# create the label vector and the corresponding semantic vector
y = np.array([0,1,2,3,4,5,6,7])
labels = ['LB_BC','RB_BC', 'LF_BC', 'RF_BC', 'LB_BP', 'RB_BP', 'LF_BP', 'RF_BP']
